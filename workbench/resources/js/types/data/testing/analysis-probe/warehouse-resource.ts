...
import type { ColorType, PriorityType, StatusType as WorkbenchStatusType } from '../workbench/app/enums';
import type { Image, User as WorkbenchUser } from '../workbench/app/models';
import type { StatusType as CrmStatusType } from '../workbench/crm/enums';
import type { User as CrmUser } from '../workbench/crm/models';

export interface WarehouseResourceProbe
{
    id: number;
    name: string;
