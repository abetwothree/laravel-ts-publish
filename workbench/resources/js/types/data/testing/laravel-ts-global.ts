...
declare global {
    ...
    export namespace workbench.app.http.resources {
        ...
        export interface BulletinArchiveResource {
            id: number;
            plucked: workbench.app.models.Comment[][];
            rows: ({ author: Pick<workbench.app.models.User, 'id' | 'name'> })[];
            own_picks: (Pick<workbench.app.models.Bulletin, 'id' | 'title'>)[];
        }
        /**
        ...
        export interface BulletinBoardResource {
            id: number;
            lists: workbench.app.models.Comment[][];
            lead_pick: Pick<workbench.app.models.User, 'id' | 'name'> | null;
        ...
        export interface BulletinCastResource {
            ...
            owner_list: workbench.app.models.User[];
        }
        /**
        ...
        export interface BulletinDigestSpreadResource {
            ...
            featured_image_url: string | null;
            is_pinned: boolean;
            comment_list: workbench.app.models.Comment[];
            author_pick: Pick<workbench.app.models.User, 'id' | 'name'>;
            own_pick: Pick<workbench.app.models.BulletinDigest, 'id' | 'title'>;
        }
        /** Reads Bulletin's accessors through a relation chain and an untyped closure parameter. */
        export interface BulletinFeedResource {
            id: number;
            lead_list: workbench.app.models.Comment[];
            owner_list: workbench.app.models.User[];
        }
        ...
        export interface BulletinLoadedResource {
            id: number;
            lead_list?: workbench.app.models.Comment[];
            lead_owner?: workbench.app.models.User;
            own_picks?: (Pick<workbench.app.models.Bulletin, 'id' | 'title'>)[];
        }
        /**
        ...
        export interface BulletinOwnershipSpreadResource {
            ...
            featured_image_url: string | null;
            is_pinned: boolean;
            owner: workbench.app.models.User;
        }
        ...
        export interface BulletinResource {
            id: number;
            list: workbench.app.models.Comment[];
            picked?: Pick<workbench.app.models.User, 'id' | 'name'>;
            own?: Pick<workbench.app.models.Bulletin, 'id' | 'title'>;
        }
        ...
        export interface BulletinWrappedResource {
            list: workbench.app.models.Comment[];
            owned_by: workbench.app.models.User;
        }
        /**
        ...
        export interface CollectionPipelineResource {
            ...
            doubled: workbench.app.models.Comment[];
            typed?: { id: number }[];
        }
        /**
        ...
        export interface PostPinnedCommentsResource {
            id: number;
            pinned_count: number;
            pinned: workbench.app.models.Comment[];
        }
        ...
        export interface ProxyFilterDirectResource {
            ...
            title: string;
            summary: Pick<workbench.app.models.Post, 'id' | 'title'>;
            without_body: Pick<workbench.app.models.Post, 'id' | 'title' | 'user_id' | 'status' | 'published_at' | 'rating' | 'category' | 'deleted_at' | 'created_at' | 'updated_at' | 'category_id' | 'visibility' | 'priority' | 'word_count' | 'reading_time_minutes' | 'featured_image_url' | 'is_pinned'>;
        ...
        export interface TeamMemberResource {
            ...
            role?: workbench.app.enums.RoleType | null;
            membership_level?: workbench.app.enums.MembershipLevelType | null;
            role_via_value?: workbench.app.enums.RoleType | null;
            avatar?: string;
            team_role?: unknown;
            joined_at?: unknown;
        ...
        export interface WarehouseReviewAppendedResource {
            id: number;
            review_level?: workbench.app.enums.StatusType | workbench.app.enums.PriorityType | null;
        }
