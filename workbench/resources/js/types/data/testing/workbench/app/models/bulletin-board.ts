...
export interface BulletinBoardMutators
{
    comment_lists: Comment[][];
    lead_author: Pick<User, 'id' | 'name'> | null;
}

export interface BulletinBoardRelations
{
    // Relations
    bulletins: Bulletin[];
    lead: Bulletin;
...
export interface BulletinBoardAll extends BulletinBoard, BulletinBoardMutators, BulletinBoardRelations {}
