...
export interface BulletinFeedMutators
{
...
export interface BulletinFeedRelations
{
    // Relations
    bulletins: Bulletin[];
    lead: Bulletin;
...
export interface BulletinFeedAll extends BulletinFeed, BulletinFeedMutators, BulletinFeedRelations {}
