...
final class PermissionsSpreadResource extends JsonResource
{
    ...
    {
        return [...$this->gatherPermissions(), ...$this->gatherLabels(), ...$this->gatherChannelLabels(), ...$this->gatherRegionLabels(), ...$this->gatherOpaqueTags(), ...$this->gatherEscapedUnits(), 'id' => $this->id];
    }
}
